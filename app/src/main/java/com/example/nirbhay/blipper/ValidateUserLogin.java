...
public class ValidateUserLogin  extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try{
            ...
            String link="http://109.73.164.163/Blipper/validate_user.php";
    ...
    protected void onPostExecute(String result){
        ...
        if(result != null && !result.isEmpty()){
            ...
            if(results[0].trim().equals("Success")) {
                ...
                resultzz = results[1].split("////");
                LoginActivity.userid = resultzz[1];
                Intent intent = new Intent(this.context, MainActivity.class);
                intent.putExtra("us_id",resultzz[0]);
                intent.putExtra("uname",resultzz[1]);
                intent.putExtra("fname",resultzz[2]);
                this.context.startActivity(intent);

            }
            else{
                Toast toast= Toast.makeText(this.context, results[0], Toast.LENGTH_SHORT);
