...
public class GetUserProfileDetails  extends AsyncTask<String,Void,String> {
    ...
    public GetUserProfileDetails(Context context) {
    ...
    protected void onPreExecute(){
        ...
        am.setTitle("Getting User Details");
        am.setMessage("Loading ... ");
        am.show();
    ...
    protected String doInBackground(String... arg0) {
        ...
        try{
            ...
            String link="http://109.73.164.163/Blipper/get_profile_details.php";
    ...
    protected void onPostExecute(String result){
        ...
        if(result != null && !result.isEmpty()){
            ...
            if(results[0].trim().equals("Success")) {
                ...
                intent.putExtra("user_det",results[1]);
                this.context.startActivity(intent);
                Toast toast= Toast.makeText(this.context, "User Profile", Toast.LENGTH_SHORT);
                toast.setMargin(150,150);
                toast.show();
            }
            else{
                Toast toast= Toast.makeText(this.context, "Unable to retrieve!", Toast.LENGTH_SHORT);
                toast.setMargin(150,150);
                toast.show();
            }
